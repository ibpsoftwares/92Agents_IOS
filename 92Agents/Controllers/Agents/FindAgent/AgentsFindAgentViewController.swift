//
//  AgentsFindAgentViewController.swift
//  92Agents
//
...
class AgentsFindAgentViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
...
//        fetchCountryAPI()
    ...
    func FindAgentAPI(){
        ...
        Webservice.apiPost1(apiURl:  "http://92agents.com/api/searchPosts", parameters: parameters, headers: nil) { (response:[String : Any], error:NSError?) in
            if error != nil {
            ...
            if let dict = response as? [AnyHashable:Any] {
                ...
                if  (dict as NSDictionary).value(forKey: "response") is NSNull{
                    ...
                    if ((dict as NSDictionary).value(forKey: "status") as? String == "100"){
                        ...
                        DispatchQueue.main.async(execute: {
                            let int1: Int32 = Int32((self.get_dest.count) * 130 )
                            let cgfloat1 = CGFloat(int1)
                            self.tableViewHeight.constant = cgfloat1 + 30
                            self.tableView.reloadData()
...
extension AgentsFindAgentViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(tableView == self.tableView)
        {
            ...
            cell1.lblName.text = (((self.get_dest ).object(at: indexPath.row) as! NSDictionary).value(forKey: "posttitle") as! String)
            ...
            cell1.lblDate.text = "Posted By: \((((self.get_dest ).object(at: indexPath.row) as! NSDictionary).value(forKey: "name") as! String))"
            if ((self.get_dest ).object(at: indexPath.row) as! NSDictionary).value(forKey: "created_at")  is NSNull {
            }
            else{
                cell1.lblExperiencee.text = "\((((self.get_dest ).object(at: indexPath.row) as! NSDictionary).value(forKey: "created_at") as! String))"
            }
            if ((self.get_dest ).object(at: indexPath.row) as! NSDictionary).value(forKey: "description")  is NSNull {
            }
            else{
                cell1.lbleDesrcription.text = (((self.get_dest ).object(at: indexPath.row) as! NSDictionary).value(forKey: "details") as! String)
            }
...
extension AgentsFindAgentViewController: UITableViewDelegate {
