//
//  BuyerDashboardViewController.swift
//  92Agents
//
...
class BuyerDashboardViewController: UIViewController {
    ...
    extension BuyerDashboardViewController: UITableViewDataSource {
    ...
    extension BuyerDashboardViewController: UITableViewDelegate {
