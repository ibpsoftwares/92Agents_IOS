...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var textColor: UIColor = UIColor.black {
        didSet {
    ...
    @IBInspectable open dynamic var tagBackgroundColor: UIColor =  UIColor( red: CGFloat(224/255.0), green: CGFloat(224/255.0), blue: CGFloat(224/255.0), alpha: CGFloat(1.0) ) {
        didSet {
            for tagView in tagViews {
    ...
    @IBInspectable open dynamic var cornerRadius: CGFloat = 5 {
        didSet {
            for tagView in tagViews {
    ...
    @objc open dynamic var textFont: UIFont = UIFont.systemFont(ofSize: 10) {
        didSet {
            for tagView in tagViews {
    ...
    open func insertTagView(_ tagView: TagView, at index: Int) -> TagView {
        ...
        tagViews[index].titleLabel?.backgroundColor = UIColor.lightGray
