//
//  SellerNotesViewController.swift
//  92Agents
//
...
class getNotes {
    ...
    var note : String
    var agentID : String
    init(id: String,name: String,postTitle : String,date : String,note : String,agentID : String,postID: String) {
        self.id = id
        self.name = name
...
class SellerNotesViewController: UIViewController {
...
extension SellerNotesViewController: UITableViewDataSource {
...
extension SellerNotesViewController: UITableViewDelegate {
